<x-layout>
    ...
    <section class="flex flex-col bg-gray-100 text-gray-800 p-12 " id="products"
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
            <div>
                <h2 class="text-md md:text-2xl lg:text-3xl font-bold mb-3 leading-8 text-start pt-4">1. Batik <span
            ...
            <div class="flex flex-col md:flex-row justify-end space-y-4 md:space-y-0 md:space-x-4 w-full md:w-auto">
                ...
                <div class="relative w-full max-w-xs md:max-w-sm">
                    ...
                    <select id="Offer2"
                        ...
                        <option value="kangkung-stingkes" class="bg-slate-100 text-slate-900">Kangkung Stingkes</option>
                        <option value="batik-larasati" class="bg-slate-100 text-slate-900">Batik Larasati</option>
                        <option value="option-4" class="bg-slate-100 text-slate-900">option 4</option>
                    </select>
                    <svg class="absolute top-1/2 transform -translate-y-1/2 right-4 z-50 text-slate-100" width="12"
                        height="12" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.0002 5.99845L8.00008 9.99862L3.99756 5.99609" stroke="currentColor"
