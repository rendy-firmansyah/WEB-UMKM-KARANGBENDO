        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="{{ route('home') }}" class="flex items-center">
                    <img src="{{ asset('images/logo-poliwangi.png') }}" class="h-8 me-3" alt="poliwangi-logo" />
                    <span class="self-center text-md font-semibold dark:text-white">Politeknik Negeri
                        Banyuwangi</span>
                </a>
            </div>
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium flex flex-col gap-4">
                        <li>
