<x-layout>
    ...
    <section class="p-6 md:p-12 w-full bg-gray-100 text-gray-800 min-h-screen flex flex-col" id="hero"
        ...
        <div class="w-full pt-20">
            <div
                ...
                <div class="flex items-center space-x-2 hidden md:flex">
                    ...
                    <div
                        class="p-2 bg-blue-200 rounded-full transform transition-transform duration-300 ease-in-out hover:scale-110">
                        <img src="{{ asset('images/DSC06880.JPG') }}" alt="logo-toko" class="w-10 h-10 rounded-full">
                    </div>
                </div>
            </div>
        ...
        <div class="bg-cyan-100 rounded-full max-w-fit px-6 py-2 flex items-center gap-4 ">
            <h2 class="font-semibold text-md md:text-lg">Tentang Toko UMKM {nama}</h2>
            <i class="ri-verified-badge-fill text-emerald-500 text-lg md:text-xl lg:text-2xl"></i>
        </div>

        <div class="my-4 flex">
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Laborum, nostrum? Numquam optio est quas
                neque a quis quam laboriosam similique reprehenderit facilis. Sapiente quia, est necessitatibus
                dolore quis ad dolorem.</p>
        </div>


        <div
            class="inline-flex items-center max-w-fit group bg-gradient-to-r from-purple-500 to-indigo-400 text-white font-semibold text-sm sm:text-base md:text-lg px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 md:py-3 rounded-full shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl">
            ...
            <div
                ...
                <div class="relative pb-[100%] overflow-hidden rounded-lg">
                    <img class="absolute inset-0 object-cover w-full h-full cursor-pointer transition-transform duration-300 hover:scale-110"
                        src="{{ asset('images/DSC06880.JPG') }}" alt="Batik Craft" onclick="openModal(this)">
                </div>
            </div>
        ...
        <!-- Modal Pop-up -->
        <div id="imageModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50 hidden">
            <div
                ...
                <div class="flex flex-col sm:flex-row gap-4 mt-6">
                    <a href="https://wa.me/nomor_penjual" target="_blank"
        ...
        <div
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4">
                ...
                <a href="https://goo.gl/maps/your_location_here" target="_blank"
